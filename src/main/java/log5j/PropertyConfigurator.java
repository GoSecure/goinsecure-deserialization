...
import log5j.config.PropertySetter;
import log5j.helpers.FileWatchdog;
import log5j.helpers.LogLog;
import log5j.helpers.OptionConverter;
import log5j.helpers.ShutdownEventListener;
import log5j.or.RendererMap;
import log5j.spi.Configurator;
import log5j.spi.Filter;
import log5j.spi.LoggerFactory;
import log5j.spi.LoggerRepository;
import log5j.spi.OptionHandler;
import log5j.spi.RendererSupport;
import log5j.spi.ThrowableRenderer;
import log5j.spi.ThrowableRendererSupport;
import log5j.spi.ErrorHandler;
...
log5j.xml.DOMConfigurator DOMConfigurator} such as
 support custom {@link log5j.spi.ErrorHandler ErrorHandlers},
 nested appenders such as the {@link log5j.AsyncAppender
AsyncAppender}, etc.
...
public class PropertyConfigurator implements Configurator {
    ...
    /** Key for specifying the {@link log5j.spi.LoggerFactory
    ...
    resetConfiguration} method before calling
     ...
     specifying an {@link log5j.or.ObjectRenderer ObjectRenderer}
     ...
     converted to String before being logged. This is done by
     specifying an {@link log5j.spi.ThrowableRenderer ThrowableRenderer}.
     ...
     As in,
     <pre>
     log4j.throwableRenderer=log5j.EnhancedThrowableRenderer
     </pre>
     ...
     log4j.appender.A1=log5j.net.SyslogAppender
     ...
     log4j.appender.A1.layout=log5j.PatternLayout
     ...
     log4j.appender.A2=log5j.RollingFileAppender
     log4j.appender.A2.MaxFileSize=10MB
     log4j.appender.A2.MaxBackupIndex=1
     log4j.appender.A2.layout=log5j.TTCCLayout
    ...
    /**
     ...
     {@link log5j.spi.LoggerFactory LoggerFactory}
                ...
                if (hierarchy instanceof ThrowableRendererSupport) {
                    ThrowableRenderer tr = (ThrowableRenderer)
                            OptionConverter.instantiateByKey(props,
                                    ...
                                    log5j.spi.ThrowableRenderer.class,
                                    null);
                    if(tr == null) {
                        LogLog.error(
