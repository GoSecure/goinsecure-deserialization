...
import log5j.helpers.DateLayout;
import log5j.spi.LoggingEvent;
...
/**
 ...
 {@link log5j.helpers.RelativeTimeDateFormat}.

 <pre>
 176 [main] INFO  log5j.examples.Sort - Populating an array of 2 elements in reverse order.
 225 [main] INFO  log5j.examples.SortAlgo - Entered the sort method.
 262 [main] DEBUG log5j.examples.SortAlgo.OUTER i=1 - Outer loop.
 276 [main] DEBUG log5j.examples.SortAlgo.SWAP i=1 j=0 - Swapping intArray[0] = 1 and intArray[1] = 0
 290 [main] DEBUG log5j.examples.SortAlgo.OUTER i=0 - Outer loop.
 304 [main] INFO  log5j.examples.SortAlgo.DUMP - Dump of interger array:
 317 [main] INFO  log5j.examples.SortAlgo.DUMP - Element [0] = 0
 331 [main] INFO  log5j.examples.SortAlgo.DUMP - Element [1] = 1
 343 [main] INFO  log5j.examples.Sort - The next log statement should be an error message.
 346 [main] ERROR log5j.examples.SortAlgo.DUMP - Tried to dump an uninitialized array.
 at log5j.examples.SortAlgo.dump(SortAlgo.java:58)
 at log5j.examples.Sort.main(Sort.java:64)
 467 [main] INFO  log5j.examples.Sort - Exiting main method.
 </pre>
...
public class TTCCLayout extends DateLayout {
    ...
    log5j.helpers.RelativeTimeDateFormat} as the date
