...
import log5j.Level;
import log5j.PropertyConfigurator;
...
public class OptionConverter {
    ...
    /**
     ...
     character is present, then the default {@link log5j.Level}
    ...
    Level toLevel(String value, Level defaultValue) {
        ...
        try {
            ...
            LogLog.warn("class [" + clazz
                    + "] is not a subclass of log5j.Level", e);
     ...
     * @param hierarchy
     *            The {@link log5j.Hierarchy} to act on.
     * @since 1.2.17
     */
    ...
    /**
     ...
     {@link log5j.xml.DOMConfigurator} is used.
     @param hierarchy The {@link log5j.Hierarchy} to act on.
    ...
    void selectAndConfigure(URL url, String clazz, LoggerRepository hierarchy) {
        ...
        if(clazz == null && filename != null && filename.endsWith(".xml")) {
            clazz = "log5j.xml.DOMConfigurator";
        }
