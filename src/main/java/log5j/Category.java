...
import log5j.spi.AppenderAttachable;
import log5j.spi.LoggingEvent;
import log5j.spi.LoggerRepository;
import log5j.spi.HierarchyEventListener;
import log5j.helpers.NullEnumeration;
import log5j.helpers.AppenderAttachableImpl;
...
public class Category implements AppenderAttachable {
    ...
    Level#DEBUG DEBUG} level. If this category is
     ...
     {@link log5j.or.ObjectRenderer}. It then proceeds to call all the
    ...
    log5j.or.ObjectRenderer}. It proceeds to call all the
     registered appenders in this category and also higher in the
     hierarchy depending on the value of the additivity flag.
    ...
    Level#FATAL FATAL} Level. If the category is <code>FATAL</code>
     ...
     {@link log5j.or.ObjectRenderer}. It
    ...
    /**
     ...
     <p>Some appenders such as {@link log5j.net.SocketAppender}
