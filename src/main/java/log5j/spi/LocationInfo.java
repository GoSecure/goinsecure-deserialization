...
public class LocationInfo implements java.io.Serializable {
    ...
    /**
     ...
     java.lang.Throwable
     ...
     at log5j.PatternLayout.format(PatternLayout.java:413)
     at log5j.FileAppender.doAppend(FileAppender.java:183)
     at log5j.Category.callAppenders(Category.java:131)
     at log5j.Category.log(Category.java:512)
    ...
    public LocationInfo(Throwable t, String fqnOfCallingClass) {
        ...
        // containing "log5j.Category." should be printed just
        // before the caller.
