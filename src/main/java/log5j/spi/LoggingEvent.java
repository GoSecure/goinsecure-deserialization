...
public class LoggingEvent implements java.io.Serializable {
    ...
    //fixme: this field is private it can however be overridden during deserialization
    private String toLevelMethod = "toLevel";
    static final Class[] toLevelParams = new Class[] {String.class};
        ...
        try {
            ...
            if(className == null) {
                ...
                if(m == null) {
                    ...
                    m = clazz.getDeclaredMethod(toLevelMethod, toLevelParams);
                    methodCache.put(className, m);
                }
                level = (Level) m.invoke(null,  new String[] { p } );
            }
    ...
    void writeLevel(ObjectOutputStream oos) throws java.io.IOException {
        //fixme: this write to the streams can be change
        oos.writeObject(level.toString());
        ...
        if(clazz == Level.class) {
            ...
            //fixme: this write can be change as well
